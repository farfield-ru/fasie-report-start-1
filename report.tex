...
\input{sections/00_method}
\input{sections/01_urdf}
\input{sections/02_sdf_stl}
\input{sections/03_step}
\input{sections/04_sim_cpu}
\input{sections/07_gpu_ode}
\input{sections/05_gui}
\input{sections/06_testing}
\input{sections/90_results}
